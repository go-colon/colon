...
import (
	...
	"github.com/go-colon/colon/core/gin/internal/bytesconv"
	"github.com/go-colon/colon/core/gin/render"
)
...
// Engine is the core's instance, it contains the muxer, middleware and configuration settings.
