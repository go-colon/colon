...
import (
	...
	testdata "github.com/go-colon/colon/core/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/go-colon/colon/core/gin.handlerNameTest$", c.HandlerName())
}
