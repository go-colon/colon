...
func NewColonTraceService(params ...interface{}) (interface{}, error) {
	c := params[0].(core.Container)
	idService := c.MustMake(contract.IDKey).(contract.IDService)
	return &ColonTraceService{idService: idService}, nil
}

// WithTrace register new trace to context
func (t *ColonTraceService) WithTrace(c context.Context, trace *contract.TraceContext) context.Context {
...
func (t *ColonTraceService) GetTrace(c context.Context) *contract.TraceContext {
	if ginC, ok := c.(*gin.Context); ok {
...
func (t *ColonTraceService) NewTrace() *contract.TraceContext {
...
func (t *ColonTraceService) StartSpan(tc *contract.TraceContext) *contract.TraceContext {
...
// GetTrace By Http
func (t *ColonTraceService) ExtractHTTP(req *http.Request) *contract.TraceContext {
	tc := &contract.TraceContext{}
...
// Set Trace to Http
func (t *ColonTraceService) InjectHTTP(req *http.Request, tc *contract.TraceContext) *http.Request {
...
func (t *ColonTraceService) ToMap(tc *contract.TraceContext) map[string]string {
	m := map[string]string{}
	if tc == nil {
		return m
	}
...
// func (t *ColonTraceService) SetTraceIDService(service contract.IDService) {
// 	t.traceIDGenerator = service
// }

// func (t *ColonTraceService) SetSpanIDService(service contract.IDService) {
