...
func TestColonMemoryService_Load(t *testing.T) {
	...
	Convey("test get client", t, func() {
		...
		Convey("remember op", func() {
			...
			objNew := Bar{}
			err = mc.Remember(ctx, "foo_remember", 1*time.Minute, func(ctx context.Context, container core.Container) (interface{}, error) {
				obj := Bar{
					Name: "bar",
				}
				return obj, nil
