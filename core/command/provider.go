...
var providerCreateCommand = &cobra.Command{
	...
	RunE: func(c *cobra.Command, args []string) error {
		...
		// 检查服务是否存在
		providers := container.(*core.ColonContainer).NameList()
...
func (sp *{{.|title}}Provider) Register(c core.Container) core.NewInstance {
...
func (sp *{{.|title}}Provider) Params(c core.Container) []interface{} {
	return []interface{}{c}
}

func (sp *{{.|title}}Provider) Boot(c core.Container) error {
	return nil
}
